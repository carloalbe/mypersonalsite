...
function MyFooter(){
    return (<>
        ...
        <footer variant="dark" className="text-center text-white realtive-bottom" style={{backgroundColor:" black",margin:"auto",bottom:0,left:0,position:"relative",minHeight:"10rem", width:"100%"}}>
  {/* Grid container */}
